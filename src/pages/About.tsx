...
const About = () => (
  <Layout>
      ...
      <div className="container">
        <div className="grid gap-5 md:grid-cols-5">
          ...
          <FadeIn delay={0.1} className="md:col-span-2">
            <div className="h-full rounded-2xl border-thicker border-foreground bg-gold/50 p-8 flex flex-col justify-center text-center shadow-hard-sm">
    ...
    {/* Team */}
    <section className="relative border-b-2 border-foreground bg-accent py-20 text-accent-foreground md:py-28 overflow-hidden">
      ...
      <div className="container relative z-10">
        <FadeIn className="mx-auto max-w-2xl text-center mb-14">
          ...
          <p className="mt-4 opacity-80">{content.team.subheading}</p>
        </FadeIn>
        <div className="grid gap-5 md:grid-cols-3">
          <FadeIn>
            <div className="rounded-2xl border-2 border-white/30 bg-white/10 p-6 flex items-center justify-center backdrop-blur-sm">
              <img src={images.illustTeam.src} alt={images.illustTeam.alt} className="h-44 w-auto object-contain drop-shadow-lg" />
            </div>
          </FadeIn>
          <FadeIn delay={0.1}>
            <div className="h-full rounded-2xl border-2 border-white/30 bg-white/10 p-7 backdrop-blur-sm">
              <Heart className="mb-4 h-6 w-6 text-gold" />
              <h3 className="text-xl font-bold">{content.team.founders.title}</h3>
              <p className="mt-3 text-sm opacity-80">{content.team.founders.body}</p>
            </div>
          </FadeIn>
          <FadeIn delay={0.2}>
            <div className="h-full rounded-2xl border-2 border-white/30 bg-white/10 p-7 backdrop-blur-sm">
              ...
              <p className="mt-3 text-sm opacity-80">{content.team.managers.body}</p>
            </div>
          </FadeIn>
        </div>
      </div>
    ...
    <section className="py-20 text-center md:py-28">
      <div className="container mx-auto max-w-xl">
        <FadeIn>
          ...
          <p className="mt-3 text-xs text-muted-foreground">{content.cta.subtext}</p>
        </FadeIn>
      </div>
    </section>
  </Layout>
